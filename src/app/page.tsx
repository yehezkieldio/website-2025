                    ...
                    <div>
                        ...
                        <article className="mt-8 text-[#8daeac] max-w-screen-sm">
                            <p className="leading-7 [&:not(:first-child)]:mt-6">
                                I&apos;m Yehezkiel Dio Sinolungan, also known as Eliziel, a software engineer based in
                                Balikpapan, Indonesia. I specialize in full-stack development, crafting seamless and
                                efficient solutions across both front-end and back-end, with the occasional dabbling in
